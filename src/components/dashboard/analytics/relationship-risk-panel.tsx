          ...
          {risk.contacts.length === 0 ? (
            ...
            <ul className="space-y-0.5">
              {risk.contacts.map((contact) => (
                <li
                  key={contact.id}
                  className="flex items-center justify-between gap-3 rounded-lg px-2 py-2 transition-[background-color,transform] duration-150 ease-[var(--ease-out-quint)] hover:bg-muted/50 active:scale-[0.995]"
                >
